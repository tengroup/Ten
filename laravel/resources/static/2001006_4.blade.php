                ...
                <div class="social-icons">
                    <ul>
                        ...
                        <font color="#f0f8ff">欢迎
                                                                    游客
                                                            登录</font>
                                                    <li><a href="http://www.u.com/login" style="color: blue">登录</a></li>
                                                <li><a href="http://www.u.com/register" style="color: blue">注册</a></li>
                        <li role="presentation" class="dropdown">
...
<div id="floatDivBoxs">
	...
	<div class="aboutRoom gray-6">
	        			<h3 class="fb"><strong>编号：</strong>4</h3>
			<p><strong>描述：</strong>    这是一个很好的房子哦                                
			</p>
	        	</div><!--/aboutRoom-->
	<div class="title">
		<span class="line"></span>
         ...
         <div class="room_detail_right">
            <div class="room_name">
            	...
            	<p class="pr">
            		...
            		<span class="price">
	            		<b></b>
	            		<span class="room_price">￥1000</span>
