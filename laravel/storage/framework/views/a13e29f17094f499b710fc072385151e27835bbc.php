...
<!--typography-page -->
	<div class="typo">
		...
		<div class="container">
            <form action="<?php echo e(URL('addhoust')); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="input-group wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                ...
                <?php if(!empty($list->h_area)): ?>
                    <input type="text" placeholder="房屋面积" maxlength="8" name="h_area" value="<?php echo e($list->h_area); ?>" id="h_area"/>㎡
                <?php else: ?>
                ...
                <?php if(!empty($list->number)): ?>
                    <input type="text" placeholder="可住人数" name="number" value="<?php echo e($list->number); ?>" maxlength="3" id="number">
                <?php else: ?>
			...
			<div class="input-group wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                ...
                <?php if(!empty($list->deposit)): ?>
                    <input type="text" placeholder="压金" name="deposit"  value="<?php echo e($list->deposit); ?>" maxlength="6" id="deposit">
                <?php else: ?>
			...
			<div class="input-group wow fadeInUp" data-wow-duration="1000ms"  data-wow-delay="300ms">
                ...
                <?php if(!empty($list->pay)): ?>
					<input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" placeholder="租金" name="pay" value="<?php echo e($list->pay); ?>" maxlength="6" id='pay'>
                <?php else: ?>
            ...
            <div class="input-group wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                ...
                <?php if(!empty($list->linkman)): ?>
                    <input type="text" class="form-control" placeholder="联系人" aria-describedby="sizing-addon2" name="linkman" value="<?php echo e($list->linkman); ?>" maxlength="6">
                <?php else: ?>
            ...
            <div class="input-group input-group-sm wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                ...
                <?php if(!empty($list->phone)): ?>
                    <input type="text" class="form-control" placeholder="联系电话" aria-describedby="sizing-addon3" name="phone" value="<?php echo e($list->phone); ?>" maxlength="15">
                <?php else: ?>
            ...
            <div class="input-group input-group-lg wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                ...
                <textarea cols="130" placeholder="这里填写您对房屋的描述" rows="10" name="content" id="content"><?php if(!empty($list->content)): ?><?php echo e($list->content); ?><?php endif; ?></textarea>
