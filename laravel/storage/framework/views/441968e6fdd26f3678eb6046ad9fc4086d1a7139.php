...
<div class="wrap-large">
    ...
    <div class="sidebar-box">
        <div class="login-hd">
            ...
            <?php /*<a href="javascript:;" class="link-btn" data-accountIdentity="1">业主</a>*/ ?>
        ...
        <div class="login-cont">
            <div class="lgoin-group" style=display:block id="usernamepwdLoginContainer">
                ...
                <form action="<?php echo e('login_pro1'); ?>" method="post" id="userloginform">
            ...
            <div class="lgoin-group" style=display:none id="smscodeLoginContainer">
                ...
                <form action="<?php echo e('loginpro2'); ?>" method="post" id="smsCodeloginform">
                    ...
                    <div class="control-group">
                        <div class="controls">
                            ...
                            <input type="button" id="dynamic" value="获取动态密码" class="verify-btn" />
                        </div>
                    </div>
...
<script>
    ...
    $("#SubmitCode").click(function(){
        ...
        if(smsCode!=smsCodes){
            ...
            $.get("<?php echo e(URL('loginpro2')); ?>",{Mobile:Mobile,smsCode:smsCode},function(e){
                if(e==1){
...
<script>
    ...
    $("#dynamic").click(function(){
        var tel=$("#Mobile").val();
        $.get("<?php echo e(URL('dynamic')); ?>",{tel:tel},function(e){
             alert("动态码已发送请注意查收")
