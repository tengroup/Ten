		...
		<div class="container">
            ...
            @foreach($arr as $v)
                <div class="col-md-4 event-grid wow flipInY" data-wow-duration="1000ms" data-wow-delay="300ms">
                    ...
                    <p class="quod"></p>
                    <div class="more">
                        <a href="{{URL('perLook?id')}}={{$v->h_id}}" class="hvr-curl-bottom-right">更多</a>
                    </div>
                </div>
             @endforeach
            ...
            <div class="event-grids">
                @foreach($arr1 as $v1)
                    <div class="col-md-4 event-grid wow flipInY" data-wow-duration="1000ms" data-wow-delay="300ms">
                        ...
                        <p class="quod"></p>
                        <div class="more">
                            <a href="{{URL('perLook?id')}}={{$v1->h_id}}" class="hvr-curl-bottom-right">更多</a>
                        </div>
                    </div>
                @endforeach
                <div class="clearfix"> </div>
            ...
            <div class="event-grids">
                @foreach($arr2 as $v2)
                    <div class="col-md-4 event-grid wow flipInY" data-wow-duration="1000ms" data-wow-delay="300ms">
                        ...
                        <p class="quod"></p>
                        <div class="more">
                            <a href="{{URL('perLook?id')}}={{$v2->h_id}}" class="hvr-curl-bottom-right">更多</a>
                        </div>
                    </div>
                @endforeach
                <div class="clearfix"> </div>
