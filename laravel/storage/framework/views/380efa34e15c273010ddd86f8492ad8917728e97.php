...
<div class="m-cont row-cont" >
    <div class="share-cont">
        <a class="a-btn" target="_blank" href="http://www.tujia.com/Account/BeginShare?state=SinaWeiBo&amp;unitID=48676"><i class="icon-sian"></i>分享到微博</a>
...
<script type="text/javascript">
   /* function sub(){
        ...
        var url="<?php echo e(URL('check_time')); ?>";
