                        ...
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        <th>用户ID</th>
                                        <th><?php echo $lists['u_id']?></th>
                                    </tr>
                                    <tr>
                                        <th>用户名</th>
                                        <th><?php echo $lists['u_name']?></th>
                                    </tr>
                                    <tr>
                                        <td>联系方式</td>
                                        <td><?php echo $lists['u_tel']?></td>
                                    </tr>
                                    <tr>
                                        <td>email</td>
                                        <td><?php echo $lists['u_email']?></td>
                                    </tr>
                                    <tr>
                                        <td>积分</td>
                                        <td><?php echo $lists['u_points']?></td>
                                    </tr>
                                    <tr>
                                        <td>注册时间</td>
                                        <td><?php echo $lists['reg_time']?></td>
                                    </tr>
                                    <tr>
                                        <td>上次登录时间</td>
                                        <td><?php echo $lists['last_login']?></td>
                                    </tr>
                                    <tr>
                                        <td>身份证</td>
                                        <td><?php echo $lists['id_card']?></td>
                                    </tr>
                                    <tr>
                                        <td>真实姓名</td>
                                        <td><?php echo $lists['real_name']?></td>
                                    </tr>
                                    <tr>
                                        <td>用户昵称</td>
                                        <td><?php echo $lists['pet_name']?></td>
                                    </tr>
                                </table>
