        ...
        <div class="container_24">
            ...
            <div class="grid_17">
                <div class="nvaBox" style="float: right;">
                    <a href="<?php echo e(URl('login')); ?>" target="_blank">登录</a> 丨 <a href="<?php echo e(URL('/')); ?>" target="_blank">U+网首页</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="column-wrap">
        ...
        <div class="main-box">
            ...
            <div class="my-form-wrap">
                <form action="<?php echo e(URL('registerpro')); ?>" autocomplete="off" id="registerForm" method="post" onsubmit="return checkall()"><input id="RefUrl" name="RefUrl" type="hidden" value="https://passport.tujia.com/PortalSite/Register/" />
