		...
		<div class="container">
			<div class="grid_3 grid_5 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
				...
				<form action="perEditSubmit" method="post" id="userloginform" onsubmit="return sss()">
						<input type="hidden" name="u_id" value="<?php echo e($user->u_id); ?>">
						<thead>
							<tr>
								<th>账号：</th>
								<th><input type="text" name="u_name" value="<?php echo e($user->u_name); ?>"></th>
							</tr>
						</thead>
						<tbody>
							<tr>
								<td>昵称：</td>
								<td><input type="text" id="pet_name" name="pet_name" value="<?php echo e($user->pet_name); ?>"><span id="petname"></span></td>
							</tr>
							<tr>
								<td>真实姓名：</td>
								<td><input type="text" id="real_name" name="real_name" value="<?php echo e($user->real_name); ?>"><span id="realname"></span></td>
							</tr>
							<tr>
								<td>邮箱：</td>
								<td><input type="text" name="u_email" value="<?php echo e($user->u_email); ?>"></td>
							</tr>
							<tr>
								<td>手机号：</td>
								<td><input type="text" name="u_tel" value="<?php echo e($user->u_tel); ?>"></td>
							</tr>
							<tr>
								<td>身份证号：</td>
								<td><input type="text" name="id_card" value="<?php echo e($user->id_card); ?>"></td>
							</tr>
							<tr>
								<td>上次登陆时间：</td>
								<td>
									<span class="badge badge-danger"><?php echo e($user->last_login); ?></span>
			...
			<div class="bs-docs-example wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
				<table class="table table-bordered">
					...
					<tbody>
						<tr>
							<td><?php echo e($list->h_address); ?></td>
