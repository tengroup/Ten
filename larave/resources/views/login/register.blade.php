    ...
    <div class="column-wrap">
        ...
        <div class="main-box">
            ...
            <div class="my-form-wrap">
                <form action="{{URL('registerpro')}}" autocomplete="off" id="registerForm" method="post"><input id="RefUrl" name="RefUrl" type="hidden" value="https://passport.tujia.com/PortalSite/Register/" />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="ipt-text" data-val="true" data-val-regex="用户名不正确" data-val-regex-pattern="" data-val-required="用户名不能为空" id="Mobile" maxlength="11" name="u_name" type="text" value="" /> <span id="errorMsgMobile"></span>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="ipt-text" data-val="true" data-val-regex="您输入的身份证号格式不正确" data-val-regex-pattern="^\d{15}|\d{18}\d{17}x$" data-val-required="身份证号不能为空" id="" maxlength="18" name="id_card" type="text" value="" /> <span id="errorMsgMobile"></span>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="ipt-text" data-val="true" data-val-regex="您输入的昵称格式不正确" data-val-regex-pattern="^1\d{10,10}$" data-val-required="昵称不能为空" id="Mobile" maxlength="11" name="pet_name" type="text" value="" /> <span id="errorMsgMobile"></span>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="ipt-text" data-val="true" data-val-regex="您输入的格式不正确" data-val-regex-pattern="^[\u4e00-\u9fa5]{2,5}$" data-val-required="真实姓名不能为空" id="Mobile" maxlength="11" name="real_name" type="text" value="" /> <span id="errorMsgMobile"></span>
                 ...
                 <!--<div class="control-group" id="tel_yzm">
                   ...
                   <!-- <div class="control-group">
                    ...
                    <div class="control-group agree-group">
                        <div class="controls">
                            <label for="chkFW">
                                <input id="chkFW" type="checkbox"  /><a href="{{URL('fuwutiaokuan')}}" target="_blank" class="link-btn">《U+网服务协议》</a>
                            </label>
                        </div>
                    </div>
